...
namespace SpartakHRM.UserService.DAL.Migrations
{
    ...
    [Migration("20230929115353_CorrectEnumInDraft")]
    partial class CorrectEnumInDraft
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SpartakHRM.UserService.DAL.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 9, 29, 11, 53, 53, 801, DateTimeKind.Utc).AddTicks(8289));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 9, 29, 11, 53, 53, 801, DateTimeKind.Utc).AddTicks(8540));
