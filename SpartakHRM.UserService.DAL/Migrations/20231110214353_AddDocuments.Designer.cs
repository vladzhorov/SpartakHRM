...
namespace SpartakHRM.UserService.DAL.Migrations
{
    ...
    [Migration("20231110214353_AddDocuments")]
            ...
            modelBuilder.Entity("SpartakHRM.UserService.DAL.Entities.OfficeEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 11, 10, 21, 43, 53, 618, DateTimeKind.Utc).AddTicks(7047));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 11, 10, 21, 43, 53, 618, DateTimeKind.Utc).AddTicks(7334));
            ...
            modelBuilder.Entity("SpartakHRM.UserService.DAL.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 11, 10, 21, 43, 53, 618, DateTimeKind.Utc).AddTicks(6498));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 11, 10, 21, 43, 53, 618, DateTimeKind.Utc).AddTicks(6829));
