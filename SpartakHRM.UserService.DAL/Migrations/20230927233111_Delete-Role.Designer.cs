...
namespace SpartakHRM.UserService.DAL.Migrations
{
    ...
    [Migration("20230927233111_Delete-Role")]
            ...
            modelBuilder.Entity("SpartakHRM.UserService.DAL.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 9, 27, 23, 31, 11, 329, DateTimeKind.Utc).AddTicks(3873));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 9, 27, 23, 31, 11, 329, DateTimeKind.Utc).AddTicks(4177));
