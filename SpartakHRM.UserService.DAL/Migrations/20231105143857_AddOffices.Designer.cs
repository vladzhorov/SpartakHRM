...
namespace SpartakHRM.UserService.DAL.Migrations
{
    ...
    [Migration("20231105143857_AddOffices")]
            ...
            modelBuilder.Entity("SpartakHRM.UserService.DAL.Entities.OfficeEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 11, 5, 14, 38, 57, 442, DateTimeKind.Utc).AddTicks(3306));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 11, 5, 14, 38, 57, 442, DateTimeKind.Utc).AddTicks(3532));
            ...
            modelBuilder.Entity("SpartakHRM.UserService.DAL.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 11, 5, 14, 38, 57, 442, DateTimeKind.Utc).AddTicks(2684));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 11, 5, 14, 38, 57, 442, DateTimeKind.Utc).AddTicks(3062));
