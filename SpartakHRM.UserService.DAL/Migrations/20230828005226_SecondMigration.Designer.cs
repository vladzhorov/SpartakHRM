...
namespace SpartakHRM.UserService.DAL.Migrations
{
    ...
    [Migration("20230828005226_SecondMigration")]
            ...
            modelBuilder.Entity("SpartakHRM.UserService.DAL.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 0, 52, 26, 418, DateTimeKind.Utc).AddTicks(5474));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 0, 52, 26, 418, DateTimeKind.Utc).AddTicks(5858));
