...
namespace SpartakHRM.UserService.DAL.Migrations
{
    ...
    [Migration("20230828000414_DefaultMigrate")]
    partial class DefaultMigrate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SpartakHRM.UserService.DAL.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 0, 4, 14, 351, DateTimeKind.Utc).AddTicks(1750));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 0, 4, 14, 351, DateTimeKind.Utc).AddTicks(2008));
